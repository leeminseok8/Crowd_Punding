...
from products.views import ProductOpenView, ProductDetailView, ProductListView, ProductAdminView, ProductFundingView
...
urlpatterns = [
    ...
    path("/funding", ProductFundingView.as_view())
]